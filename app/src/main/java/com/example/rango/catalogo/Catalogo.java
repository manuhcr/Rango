package com.example.rango.catalogo;
import com.example.rango.lugar.Lugar;
...
import java.util.Set;
    ...
    public final class Catalogo {
        ...
        /**
         * Ordena do mais votado para o menos votado. Empate desempata pelo nome,
         * senão a ordem fica instável e o ranking pisca sem motivo.
         */
